...
void Derived :: process(){
    setdata(); //it is in the private scope of derived class
...
int main(){
    Derived d1;
    //d1.setdata(); //here it is in the private scope of derived class
    // we can all it inside process member function of derived class
